<header class="w-full z-50">
  ...
  function renderMenu($menu)
  {
    ...
    echo '<nav class="items-center flex flex-row justify-between bg-blue-900 text-white px-4 xl:py-5">';
    echo '<div class="order-0"><img src="./assets/img/logo.svg" alt="Logo" class="w-44 mx-auto"></div>';
    echo '<ul class="flex flex-row gap-3 text-light font-semibold uppercase">';
