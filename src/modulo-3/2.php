...
<section>
  ...
  <?php ob_start(); ?>
    <ol class="ol-number">
      ...
      <li>Para la realización de tu producto, considera los elementos señalados en la <a target="_blank" href="<?php echo PATH_DOCS . 'Actividad3_Rubrica.pdf'; ?>">rúbrica de evaluación</a>.</li>
    ...
    <ol class="ol-number">
      ...
      <li>Para la elaboración de tu trabajo considera los elementos señalados en la lista de cotejo, así como el texto <a target="_blank" href="<?php echo PATH_DOCS . 'actividad2_04_Como_Resumir_un_Texto_Fin.pdf'; ?>">¿Cómo realizar un resumen?</a> </li>
...
<section>
  ...
  <ol class="ol-number">
    ...
    <li>Para la elaboración de tu secuencia, ocupa el siguiente formato: secuencia didáctica primera entrega.</li>
    ...
    <li>Antes de entregar tu secuencia didáctica, revisa que cumpla con los elementos señalados en la lista de cotejo de secuencia didáctica (primera entrega).</li>
