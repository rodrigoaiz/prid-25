...
<section>
  ...
  <div class="grid grid-cols-1 md:grid-cols-3 gap-6 w-full justify-center items-center my-10">
    <div class="md:col-span-2">
      <p>Como parte del Plan de Estudios, el Colegio cuenta con un documento denominado <em>Orientación y Sentido de las Áreas</em> en el cual se describe ampliamente la orientación disciplinaria de cada una de las cuatro Áreas académicas que integran el Plan de Estudios y su sentido educativo.</p>
  ...
  <p>Cabe aclarar que la primera versión de este documento se publicó en el año 2006, y en 2025 fue aprobada por el H. Consejo Técnico del Colegio la versión actualizada.</p>
