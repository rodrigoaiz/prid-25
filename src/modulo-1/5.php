...
<section>
  <p class="text-lg font-black text-center mb-10">Éstas y otras preguntas son respondidas por las y los docentes, incluso sin proponérselo, porque la ética guía el accionar humano y, basado en su ética, el profesor decide qué decir y cómo comportarse frente a los alumnos.</p>
  <p class="mt-10">En este sentido, es trascendental que la planta docente se reconozca como ejemplo a seguir (o no) en su accionar diario. El docente puede enseñar matemáticas, biología, filosofía, inglés o redacción, no obstante, igualmente muestra y hace que los y las estudiantes aprendan valores como: la solidaridad, la tolerancia, la inclusión, el respeto, la autonomía, el amor y la responsabilidad.</p>
